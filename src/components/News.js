...
export class News extends Component {
  ...
  async updateNews() {
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=82afe9a261a148e299e8a33df9347b39&page=${this.state.page}&pageSize=${this.props.pageSize}`;
